...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    UINavigationController *navigationController1 = [[[UINavigationController alloc] initWithRootViewController:viewController] autorelease];
    
    QRootElement *root = [AboutDataBuilder create];
//    ExampleViewController *quickformController = (ExampleViewController *) [[ExampleViewController alloc] initWithRoot:root];
    AboutViewController *aboutViewController = (AboutViewController *)[[AboutViewController alloc] initWithRoot:root];
//    AboutViewController *aboutViewController = [[[AboutViewController alloc] initWithNibName:@"AboutViewController" bundle:nil] autorelease];
    UINavigationController *navigationController2 = [[[UINavigationController alloc] initWithRootViewController:aboutViewController] autorelease];
